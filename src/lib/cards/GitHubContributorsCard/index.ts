...
export type GitHubContributorsLoadedData = Record<string, GitHubContributor[] | undefined>;

export const GitHubContributorsCardDefinition = {
	...
	groups: ['Social'],
	keywords: ['github', 'contributors', 'open source', 'repository'],
	...
	canHaveLabel: true
} as CardDefinition & { type: 'githubContributors' };
